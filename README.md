...
- [Capítulo IV: Solution Software Design](docs/04-solution-software-design.md)
  ...
  - [4.2. Tactical-Level Domain-Driven Design](docs/04-solution-software-design.md#42-tactical-level-domain-driven-design)
    - [4.2.4. Bounded Context: Devices (Device Management)](docs/04-solution-software-design.md#424-bounded-context-devices-device-management)
      - [4.2.4.1. Domain Layer](docs/04-solution-software-design.md#4241-domain-layer)
      - [4.2.4.2. Interface Layer](docs/04-solution-software-design.md#4242-interface-layer)
      - [4.2.4.3. Application Layer](docs/04-solution-software-design.md#4243-application-layer)
      - [4.2.4.4. Infrastructure Layer](docs/04-solution-software-design.md#4244-infrastructure-layer)
      - [4.2.4.5. Bounded Context Software Architecture Component Level Diagrams](docs/04-solution-software-design.md#4245-bounded-context-software-architecture-component-level-diagrams)
      - [4.2.4.6. Bounded Context Software Architecture Code Level Diagrams](docs/04-solution-software-design.md#4246-bounded-context-software-architecture-code-level-diagrams)
      - [4.2.4.6.1. Bounded Context Domain Layer Class Diagrams](docs/04-solution-software-design.md#42461-bounded-context-domain-layer-class-diagrams)
      - [4.2.4.6.2. Bounded Context Database Design Diagram](docs/04-solution-software-design.md#42462-bounded-context-database-design-diagram)
